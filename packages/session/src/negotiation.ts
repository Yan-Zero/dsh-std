import type { CapabilityAgreement, CapabilityBindingDraft, ConnectionNegotiationPolicy } from '@dsh-std/connection'
import type { ProtocolIssue, ProtocolNegotiationInput, ProtocolNegotiationOutcome } from '@dsh-std/core'

interface SessionRequirementSpec {
  readonly operations: readonly string[]
  readonly optionalOperations?: readonly string[]
  readonly sessionDomain?: string
}

interface SessionSupportSpec {
  readonly sessionDomain: string
  readonly operations: readonly string[]
}

export function negotiateSessionCapability<
  Requirement extends SessionRequirementSpec,
  Support extends SessionSupportSpec,
>(
